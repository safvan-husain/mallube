    ...
    async (req: any, res: any) => {
        try {
            ...
            const stores = await Store.aggregate([
                ...
                {
                    $project: {
                        storeName: 1, bio: { $ifNull: ["$bio", ""] }, address: { $ifNull: ["$address", ""] }, openTime: { $ifNull: ["$openTime", 0] }, closeTime: { $ifNull: ["$closeTime", 0] },
                        isDeliveryAvailable: { $ifNull: ["$isDeliveryAvailable", false] }, instagram: { $ifNull: ["$instagram", ""] }, facebook: { $ifNull: ["$facebook", ""] }, whatsapp: { $ifNull: ["$whatsapp", ""] },
                        phone: { $ifNull: ["$phone", ""] }, shopImgUrl: { $ifNull: ["$shopImgUrl", ""] }, service: { $ifNull: ["$service", false] }, location: 1, city: { $ifNull: ["$city", ""] },
                        distance: { $toString: "$distance" },
